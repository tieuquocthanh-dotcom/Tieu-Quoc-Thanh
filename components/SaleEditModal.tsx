...
const SaleEditModal: React.FC<SaleEditModalProps> = ({ isOpen, onClose, sale }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Logic to update sale notes would go here
    onClose();
  };
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md border-4 border-slate-800 overflow-hidden animate-fade-in-down">
        <div className="bg-primary p-4 text-white flex justify-between items-center">
          <h3 className="font-black uppercase text-sm flex items-center"><Edit className="mr-2" size={20}/> Sửa đơn hàng</h3>
